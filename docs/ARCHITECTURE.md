...
- `npm test` passa: **201 test in 14 file**, ~12.5 s (undici e mezzo dei quali spesi nel solo
...
- Il costo — perdere il controllo statico — è compensato in parte dai commenti `@param` /
  ...
  test, che sul `core/` resta la parte più densa: dei 201 test, 102 riguardano il `core/`
  (griglia, punteggio, bombe, generatore, motore, invarianti), 30 i Quadri (definizione, svolgimento e testi della schermata di apertura), 35 l'i18n (chiavi, traduzioni, ortografia italiana e regole della presentazione), 6 la
