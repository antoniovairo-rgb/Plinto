...
| Voce | Stato | Nota |
| --- | --- | --- |
| Nucleo di gioco stabile | **FATTO** | 500 test in 29 file; invarianti verificate a ogni mossa su 240 partite complete; i cento livelli rigiocati nell'app a ogni giro completo del gate |
