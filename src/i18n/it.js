...
export default {
  ...
  attrezzi: {
    ...
    piccone: 'Il piccone',
    picconeSpiega: 'Toglie un quadratino già posato sulla griglia. Non costa una mossa.',
    picconeScegli: 'Quale quadratino tolgo?',
    mensola: 'La mensola',
    ...
    quantiHaiUno: 'Puoi usare gli attrezzi ancora 1 volta. Scegli tu quale ti serve: l\'uso si consuma solo se l\'attrezzo fa davvero qualcosa.',
    quantiHai: 'Puoi usare gli attrezzi ancora {n} volte. Ogni volta scegli tu quale ti serve: l\'uso si consuma solo se l\'attrezzo fa davvero qualcosa.',
    comeSiGuadagnano: 'Per ora non puoi usare gli attrezzi. Guadagni 1 uso ogni {n} livelli superati, e ne puoi mettere da parte al massimo 3.',
    guadagnato: 'Hai guadagnato 1 uso degli attrezzi.',
    guadagnatiTanti: 'Hai guadagnato {n} usi degli attrezzi.',
    oraNeHai: 'Adesso puoi usarli {n} volte.',
    oraNeHaiUno: 'Adesso puoi usarli 1 volta.',
    perso: 'Avevi già il massimo di 3 usi, quindi quello appena guadagnato è andato perso. Usa un attrezzo per fare posto.',
    persiTanti: 'Avevi già il massimo di 3 usi, quindi {n} usi appena guadagnati sono andati persi. Usa un attrezzo per fare posto.',
  },
  ...
  quadri: {
    ...
    legendaAttrezzo: 'La cassetta segna i livelli che ti fanno guadagnare 1 uso degli attrezzi: uno ogni {n} livelli superati.',
    quiAttrezzo: 'Superandolo guadagni 1 uso degli attrezzi',
    superato: 'Superato',
  ...
  guida: {
    ...
    percorso: 'Il gioco vero sono {n} livelli. Ognuno ha il suo obiettivo e un numero di mosse per riuscirci, e prima di cominciare ti spiega che cosa devi fare. Più avanti qualche livello ne chiede due insieme — tre righe e quattrocento punti, per dire — e allora servono tutti e due, con le stesse mosse. Ogni {attrezziOgni} livelli superati guadagni 1 uso degli attrezzi: quando ti blocchi scegli tu quale usare fra la carriola, il gessetto, il piccone e la mensola.',
  ...
  aiuto: {
    ...
    attrezzi: 'Gli attrezzi sono quattro: la carriola, il gessetto, il piccone e la mensola. Giocando non guadagni un attrezzo preciso ma un uso: 1 ogni {ogni} livelli superati, fino a un massimo di {massimo} da parte. Ogni volta scegli tu quale attrezzo usare. Aprire il pannello per guardarli non costa niente: l\'uso si consuma solo quando l\'attrezzo fa davvero qualcosa.',
