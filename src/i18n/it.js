...
export default {
  ...
  hud: {
    ...
    respiroFinito: 'se la prossima mossa non elimina niente, la Catena scende',
    menu: 'Menu',
  },
  modo: {
    ...
    sfidaCosaPassata: 'La stessa partita di quel giorno. Fai più punti che puoi.',
  },
  gioca: {
  ...
  incita: {
    ...
    recupero: [
      ...
      'Proprio in tempo!', 'Griglia salva!', 'Si torna a giocare!',
      'Rimessa in piedi!', 'Che uscita!', 'Riaperta!',
    ],
    svuotata: [
      'Griglia pulita!', 'Griglia vuota!', 'Tutto pulito!', 'Non è rimasto niente!',
      'Ripulita tutta!', 'Griglia azzerata!',
    ],
  },
  fine: {
  ...
  anteprima: {
    titolo: 'Prossimi tre pezzi',
    nessuna: 'Prossimi tre pezzi: non ancora pronti',
    conBomba: 'con bomba',
    spiegazione: 'Nei livelli vedi in anticipo i prossimi tre pezzi, così puoi pianificare le mosse che ti restano. Nella partita libera no: lì non sai che cosa arriva.',
    tasto: 'Premi P per leggere i prossimi tre pezzi',
  },
  scheda: {
    condividi: 'Condividi il risultato',
    copiato: 'Copiato negli appunti: incollalo dove vuoi.',
    condiviso: 'Condiviso.',
    copiaAMano: 'Non sono riuscito a copiare: seleziona il testo qui sotto e copialo tu.',
    ...
    condividiQuadro: 'Condividi il risultato',
  ...
  profilo: {
    ...
    qualiPartite: 'Contano la partita libera e la Sfida del giorno. I livelli no: partono da griglie già disegnate e cambierebbero la mappa.',
    insieme: 'Nell\'insieme',
    partite: 'Partite',
    mosse: 'Mosse',
    migliorPunteggio: 'Record',
    migliorMossa: 'Mossa migliore',
    svuotamenti: 'Griglie svuotate',
    bombe: 'Bombe esplose',
    celleEsplose: 'Caselle portate via',
    comeChiudi: 'Come chiudi i gruppi',
    comeChiudiSpiega: 'Un quadrante vale {quadrante} punti base, una riga o una colonna {riga}. Se chiudi quasi solo righe, lasci da parte il gruppo che vale di più.',
    gruppo: 'Gruppo',
    quanti: 'Quanti',
    quota: 'Quota',
    righe: 'Righe',
    colonne: 'Colonne',
    quadranti: 'Quadranti',
    catena: 'A che Catena giochi',
    catenaSpiega: 'Per ogni mossa, la Catena che avevi prima di giocarla: è quella che ha moltiplicato i punti di quella mossa.',
    livello: 'Moltiplicatore',
    tue: 'Tu',
    stratega: 'Stratega',
    riferimento: 'Il confronto è con un giocatore artificiale, non con altre persone: {partite} partite simulate, misurate il {data}.',
    senzaRiferimento: 'Il confronto con il giocatore artificiale non c\'è: è stato misurato con regole diverse da quelle di adesso.',
    mappa: 'Dove appoggi i pezzi',
    mappaSpiega: 'Quante volte hai appoggiato un pezzo in ogni casella. Due giocatori con lo stesso punteggio hanno mappe diverse.',
  ...
  archivio: {
    ...
    spiegazione:
      'Puoi giocare anche le sfide dei giorni passati. Quelle dei giorni futuri si aprono '
  ...
  attrezzi: {
    ...
    carriolaSpiega: 'Cambia un pezzo della mano con uno nuovo. Non costa una mossa.',
    ...
    quantiHaiUno: 'Hai 1 gettone. Con un gettone usi un attrezzo, quello che scegli tu. Il gettone si spende solo se l\'attrezzo fa davvero qualcosa.',
    quantiHai: 'Hai {n} gettoni. Con ogni gettone usi un attrezzo, quello che scegli tu. Il gettone si spende solo se l\'attrezzo fa davvero qualcosa.',
    comeSiGuadagnano: 'Non hai gettoni. Ne guadagni 1 ogni {n} livelli superati, e ne tieni al massimo 3. Con ogni gettone usi un attrezzo.',
    guadagnato: 'Hai guadagnato 1 gettone per gli attrezzi.',
    guadagnatiTanti: 'Hai guadagnato {n} gettoni per gli attrezzi.',
    oraNeHai: 'Adesso hai {n} gettoni.',
    oraNeHaiUno: 'Adesso hai 1 gettone.',
    perso: 'Avevi già il massimo di 3 gettoni, quindi quello appena guadagnato è andato perso. Usa un attrezzo per fare posto.',
    persiTanti: 'Avevi già il massimo di 3 gettoni, quindi {n} gettoni appena guadagnati sono andati persi. Usa un attrezzo per fare posto.',
  },
  ...
  salvataggio: {
    ...
    portaVia: 'Crea un salvataggio',
    rimetti: 'Carica un salvataggio',
  ...
  quadri: {
    ...
    legendaAttrezzo: 'La cassetta segna i livelli che ti fanno guadagnare 1 gettone per gli attrezzi: uno ogni {n} livelli superati.',
    quiAttrezzo: 'Superandolo guadagni 1 gettone per gli attrezzi',
    superato: 'Superato',
    ...
    didascalie: {
      ...
      intrecci: 'Due gruppi chiusi con la stessa mossa. Qui va fatto più volte.',
    ...
    spiegazioni: {
      ...
      catena: 'La Catena sale di uno ogni volta che elimini qualcosa, e scende se fai due mosse di fila senza eliminare niente.',
  ...
  intro: {
    ...
    tre: 'Hai in mano tre pezzi alla volta. I tre nuovi arrivano quando li hai messi tutti sulla griglia.',
  ...
  aiuto: {
    ...
    rimetti: 'Se lasci il pezzo dove non volevi, sotto la griglia compare "Rimetti a posto il pezzo": la partita torna esattamente com\'era. Funziona solo se quella mossa non ha eliminato niente e non ha chiuso la partita, e serve a correggere un tocco sbagliato, non a cambiare idea.',
    ...
    attrezzi: 'Gli attrezzi sono quattro: la carriola, il gessetto, il piccone e la mensola. Per usarli servono i gettoni: ne guadagni 1 ogni {ogni} livelli superati, e ne tieni al massimo {massimo}. Con ogni gettone usi un attrezzo, quello che scegli tu. Aprire il pannello per guardarli non costa niente: il gettone si spende solo quando l\'attrezzo fa davvero qualcosa.',
    attrezziSfida: 'Nella Sfida del giorno gli attrezzi non ci sono, ed è voluto: è la stessa partita per tutti, e due punteggi ottenuti usando gli attrezzi un numero diverso di volte non sarebbero più confrontabili.',
