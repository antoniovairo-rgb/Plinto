...
export default {
  ...
  attrezzi: {
    ...
    piccone: 'The pickaxe',
    picconeSpiega: 'Removes one block already on the board. It costs no move.',
    picconeScegli: 'Which block do I remove?',
    mensola: 'The shelf',
    mensolaSpiega: 'Park a piece on it and take it back whenever you like.',
    ...
    quantiHaiUno: 'You have 1 tool: you decide how to use it. You only spend it if it actually does something.',
    quantiHai: 'You have {n} tools: you decide which one to use. You only spend one if it actually does something.',
  ...
  aiuto: {
    ...
    attrezzi: 'Tools are helpers you earn by playing: one arrives every {ogni} levels cleared, and you can hold up to {massimo}. They are not four separate stocks: you hold a single number, and you decide which tool to spend it on. Opening the panel to look at them is free: a tool is spent only when it actually does something.',
