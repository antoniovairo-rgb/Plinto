...
export default {
  ...
  aiuto: {
    ...
    tinta: 'Tint: a cleared group is worth more when many of its cells share one colour. It starts paying from {soglia} matching cells and reaches +{massimo}% at nine. It is not luck: you do not choose the colours of the pieces, but you choose where to put them, and that is how a majority is built.',
    bombeTitolo: 'Bombs',
